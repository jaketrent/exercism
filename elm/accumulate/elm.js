...
var _exercism$xelm$Accumulate$addToSet = F3(
	function (transform, set, newSet) {
		addToSet:
		while (true) {
			var _p0 = set;
			if (_p0.ctor === '[]') {
...
var _exercism$xelm$Accumulate$accumulate = F2(
	function (transform, set) {
		return A3(
			_exercism$xelm$Accumulate$addToSet,
			transform,
			set,
			_elm_lang$core$Native_List.fromArray(
				[]));
...
_elm_lang$core$Native_Platform.addPublicModule(Elm['Accumulate'], 'Accumulate', typeof _exercism$xelm$Accumulate$main === 'undefined' ? null : _exercism$xelm$Accumulate$main);
